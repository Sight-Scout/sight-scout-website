...
> Rule, but it is not legal advice. Have an attorney review before launch.
...
pages and the interactive demonstration.

### 1. Who may use the Site

The Site is intended for adults. You must be at least 18 years old (or the age of majority
where you live) to submit any information to us, including your email address. The Site is
...
advice, and it is not a substitute for the advice, diagnosis, or treatment of a physician,
optometrist, ophthalmologist, or other qualified health professional.
...
### 3. The demonstration activity

The Site includes an interactive demonstration of the style of activity used in the App. The
demonstration is provided solely so visitors can see how the activity feels. It is not a
vision test or screening of any kind: it does not adapt to the user, does not measure
anything, produces no results, and stores no data. Do not use the demonstration to assess
anyone's vision.

### 4. Acceptable use

You agree not to: (a) use the Site in any way that violates applicable law; (b) attempt to
gain unauthorized access to the Site or its hosting infrastructure; (c) scrape, harvest, or
collect information about other visitors; (d) misrepresent the Site's content, including
presenting the demonstration as a medical test; or (e) frame or mirror the Site in a manner
that removes or obscures its disclosures.
...
The Site links to third-party websites (for example, professional and governmental health
organizations) for educational purposes. We do not control and are not responsible for their
content or privacy practices, and a link does not imply endorsement by us or by them.
...
FOR A PARTICULAR PURPOSE, ACCURACY, AND NON-INFRINGEMENT. WE DO NOT WARRANT THAT THE SITE
...
We may update the Site and these Terms from time to time. The "Last updated" date at the top
of this page reflects the current version. Material changes will be indicated by updating
that date; your continued use of the Site after changes take effect constitutes acceptance.
...
- **Email address (optional, from you).** If you sign up for launch updates, we collect the
  email address you provide. That is the only information the Site asks you for.
- **Basic technical logs.** Our hosting provider automatically records standard server logs
  (IP address, browser type, pages requested, timestamps) for security and reliability. We
  do not use these logs to identify or profile visitors.
- **Nothing else.** The Site sets no cookies, uses no advertising or analytics trackers, and
  embeds no third-party social widgets. The interactive demonstration runs entirely in your
  browser: it sends nothing to us and stores nothing on your device.
...
You may wonder whether laws like HIPAA protect information here. Here is the accurate
picture:

- **HIPAA does not apply to us.** The Health Insurance Portability and Accountability Act
  covers healthcare providers, health plans, healthcare clearinghouses, and their business
...
Launch-list email addresses are kept until you unsubscribe or until the launch list is
retired, whichever comes first, and are then deleted. Hosting logs are retained per our
hosting provider's standard rotation and are not archived by us.
...
The Site is served over HTTPS. Launch-list addresses are stored with access limited to the
people who operate Sight Scout. No method of transmission or storage is perfectly secure,
but our best protection is structural: we simply do not hold much of your data.

### 8. Changes to this policy

If our practices change, we will update this page and its "Last updated" date before the
change takes effect. If a change materially affects the launch list (the only personal
information you can give us here), we will email the list before applying it.
...
*Route: `/legal/childrens-privacy` · Page title: Children's Privacy · Last updated: July 4, 2026*

Sight Scout is a project about children, so we hold ourselves to a higher bar on children's
privacy. This page explains, in plain language, how the website and the App each approach it.
...
The App is designed around the Children's Online Privacy Protection Act (COPPA), including
the FTC's amended COPPA Rule (in effect since 2025), and around a simpler principle: collect
as little as possible, and let parents stay in charge.

- **Parents run the show.** Accounts and profiles are created and managed by a parent or
...
## §D — Medical & Regulatory Disclosure

*Route: `/legal/medical-disclosure` · Page title: Medical & Regulatory Disclosure · Last updated: July 4, 2026*

We would rather over-explain this than have one family misunderstand it.

### What Sight Scout is

Sight Scout is a wellness and education tool: a structured, playful vision activity that
parents run with their children at home, built on the visual-angle geometry, logMAR scale,
and adaptive-staircase statistics used in vision science. Its purpose is to help families
stay engaged with their children's vision and to encourage timely, comprehensive care from
eye care professionals.

### What Sight Scout is not

- **Not a medical device.** Sight Scout is not intended to diagnose, treat, cure, mitigate,
  or prevent any disease or condition, including amblyopia.
- **Not FDA reviewed.** Sight Scout has not been reviewed, cleared, or approved by the U.S.
  Food and Drug Administration. It is offered as a low-risk general wellness product
  consistent with FDA's published policy for such products.
- **Not a vision test or screening.** Sight Scout does not screen for, detect, or rule out
  amblyopia or any other condition. Reassuring activity sessions are not a clean bill of
  health, and no output of the App is a diagnosis or a medical result.
- **Not a substitute for professional care.** Only a comprehensive examination by an
  optometrist or ophthalmologist can assess a child's eye health. Follow the professional
  screening and examination schedule recommended by your pediatrician and eye care
  providers regardless of anything in the App.
...
Contact an eye care professional or physician promptly if a child has: an eye that drifts,
turns, or wanders; persistent squinting, head tilting, or closing of one eye; complaints of
blurry or double vision; light sensitivity or eye pain; a white, yellowish, or unusual glow
in the pupil (especially noticeable in photographs); or any change in vision after an injury.
For emergencies, call your doctor or local emergency services immediately.
...
We build to the Web Content Accessibility Guidelines (WCAG) 2.2, Level AA. Specifically,
this site is designed to provide:

- Full keyboard operability, including the interactive demonstration.
- Text alternatives for meaningful images and plain-English descriptions for mathematical
  notation.
- Color contrast meeting or exceeding AA ratios throughout.
- Layouts that remain usable at 200% zoom and on small screens, with text sized in relative
  units.
- Motion that respects your system's reduced-motion preference.
- Semantic structure (landmarks, headings, labels) for assistive technology.
